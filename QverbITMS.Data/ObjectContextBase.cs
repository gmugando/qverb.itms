...
using QverbITMS.Core.Data.Hooks;
...
namespace QverbITMS.Data
{
    ...
    /// Object context
    /// </summary>
    [DbConfigurationType(typeof(QverbITMSDbConfiguration))]
        ...
        private void PerformPreSaveActions(out IList<DbEntityEntry> modifiedEntries, out HookedEntityEntry[] modifiedHookEntries)
        {
            ...
            if (hooksEnabled)
            {
                modifiedHookEntries = modifiedEntries
                                ...
                                {
                                    Entity = x.Entity,
                                    PreSaveState = (QverbITMS.Core.Data.EntityState)((int)x.State)
                                })
                                .ToArray();
